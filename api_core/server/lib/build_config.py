...
from bson.json_util import loads as bloads, dumps as bdumps
...
try:
    ...
    WEB_SERVER_TIMER_PORT = CONFIG["instance"][3]['port']
    WEB_SERVER_REPORT_PORT = CONFIG["instance"][4]['port']
...
RAZORPAY_UID = CONFIG['payment'][0]['username']
RAZORPAY_PWD = CONFIG['payment'][0]['password']

TWILIO_ACCSID = CONFIG['whatsapp_gw'][0]['key']
TWILIO_AUTHTOKEN = CONFIG['whatsapp_gw'][1]['key']
