...
@xenSecureV1
class MtimeAccomodationNoregCheckinV2Handler(tornado.web.RequestHandler,
        MongoMixin):
                        ...
                        if self.apiId == 402021:
                            ...
                            for k,j in enumerate(touristCountStr):
                                ...
                                if k == 0:
                                    ...
                                    for x in range(0,6):
                                        try:
                                            liveProof1Key = 'liveProof_' + str(k) + '_' + str(x)
                                            Log.i('live_proof_1_key', liveProof1Key)
                                            #Log.i('live_proof', self.request.files)
                                            liveProof1 = self.request.files[liveProof1Key][0]
                                ...
                                if country == None or country == "":
                                    state = None
                                pincode = self.request.arguments.get('pincode')
                                if pincode == None or pincode == "":
                                    pincode = None
                                district = self.request.arguments.get('district')
                                ...
                                if k == 0:
                                    faceProofTime = liveProofTime[3]
                                    faceProofType = liveProofType[3]
                                else:
                                    faceProofTime = id1Time
                                    faceProofType = id1ProofType
