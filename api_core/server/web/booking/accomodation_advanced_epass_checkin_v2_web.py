...
import base64
@xenSecureV1
class MtimeAccomodationAdvancedePassCheckinV2WebHandler(tornado.web.RequestHandler,
        MongoMixin):
                ...
                if len(app):
                    ...
                    if self.apiId in [ 402021, 402022]:
                        if self.apiId == 402021:
                            ...
                            touristBookingFindQ = self.touristBook.find(
                                                    {
                                                        '_id':bookingId,
                                                        'touristId':touristId
                                                    }
                            ...
                            touristBookingFind = []
                            async for i in touristBookingFindQ:
                                touristBookingFind.append(i)

                            if not len(touristBookingFind):
                                code = 4930
                                status = False
                            ...
                            try:
                                sourceWeb = str(self.request.arguments['sourceWeb'][0].decode())
                                if sourceWeb == "true":
                                    sourceWeb = True
