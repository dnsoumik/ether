...
@xenSecureV1
class MtimeAccomodationAdvancePriceCheckV2Handler(tornado.web.RequestHandler,
        MongoMixin):
                ...
                if len(app):
                    ...
                    if self.apiId in [ 402020, 402021]:
                        if self.apiId == 402020 or 402021:
                            ...
                            totalAmount = float((numOfRoom * amount))
                            ...
                            '''
                            bookingTime = timeNow()
                            bookingTimeN = int(bookingTime/1000000) - 19800
