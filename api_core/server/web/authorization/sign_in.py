            ...
            if len(app):
                ...
                if method == 0:
                    ...
                    if len(account):
                        ...
                        if profile[0].get('lastSignInRequest') != None and profile[0].get('lastSignInRequest') > self.time - 1200000000:
                        ...
                        if phoneNumber in [911234567890, 917005612276, 919738378908, 919612342112, 917005464481, 917005612277, 917005612278]:
                            nOtp = 123456
