...
@xenSecureV1
class MtimeWebServiceProviderHandler(tornado.web.RequestHandler,
        MongoMixin):
                ...
                if len(app):
                    ...
                    if app[0]['apiId'] in [402020, 402021, 402022]:  # TODO: till here
                        if self.apiId == 402022:
                            try:
                                srvType = int(self.request.arguments['type'][0].decode())
                            except:
