...
@xenSecureV1
class MtimeTourOperatorSearchHandler(tornado.web.RequestHandler,
        MongoMixin):
                                ...
                                if len(accList):
                                    for res in accList:
                                        ...
                                        v = {
                                                ...
                                                'proprietorName':res['basicInfo'][0]['ownerName'],
                                                'contactNumber':res['basicInfo'][0]['mobileNumber'],
                                                'organizationName':res['basicInfo'][0]['organizationName'],
                                                'address':res['basicInfo'][0]['address'],
                                                'emailAddress':res['basicInfo'][0]['emailAddress'],
