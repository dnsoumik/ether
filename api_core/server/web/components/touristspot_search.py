...
@xenSecureV1
class MtimeTouristSpotSearchHandler(tornado.web.RequestHandler,
        MongoMixin):
                                ...
                                if len(accList):
                                    for res in accList:
                                        ...
                                        v = {
                                                        ...
                                                        'touristSpotName':res['basicInfo'][0]['touristSpotName'],
                                                        'contactNumber':res['basicInfo'][0]['mobileNumber'],
                                                        'district':res['basicInfo'][0]['district'],
